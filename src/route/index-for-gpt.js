...
router.post('/purchase-edit', function (req, res) {
  const id = Number(req.body.id) // Отримуємо ID з тіла запиту
...
// Завдання 1: знайти у коді де саме створюється bonus та при створенні зробити округлення до більшого цілого числа.
// Завдання 2: Де саме створюється id товару і чому воно статичне. Зробити зростаючим id незалежно від того що обирається той самий товар. Таж потрібно зробити неповторне зростаюче id замовлення та id покупця.
// Завдання 3: яким чином та за яким посиланням пожна перейти зі сторінки purchase-list на сторінку purchase-edit так само як із purchase-orderinfo для оновлення інформації про користувача.
// Завдання 4: чому в консолі не відображується категорії з масиву
// [
//   { id: 2, text: 'Топ продажів' },
//   { id: 1, text: 'Готовий до відправки' },
// ]
// Треба зробити щоб відображувались.
